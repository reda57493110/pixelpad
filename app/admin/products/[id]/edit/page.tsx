  ...
  const loadProduct = useCallback(async (id: string) => {
    try {
      ...
      if (product) {
        ...
        setVariants((product.variants || []) as Array<{ ram: string; storage: string; storageType: string; price: number; originalPrice?: number }>)
      }
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const productData = {
        ...
        showOnProductPage: true, // Always true - products should always appear on products page
